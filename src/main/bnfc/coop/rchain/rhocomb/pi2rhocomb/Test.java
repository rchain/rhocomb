...
import coop.rchain.rhocomb.pi2rhocomb.*;
...
public class Test
{
  ...
  public coop.rchain.rhocomb.pi2rhocomb.Absyn.Req parse() throws Exception
  {
    /* The default parser is the first-defined entry point. */
    /* Other options are: */
    /* not available. */
    coop.rchain.rhocomb.pi2rhocomb.Absyn.Req ast = p.pReq();
    System.out.println();
