...
public class RCRBrl  extends RCRComb {
  public final RCRName rcrname_1, rcrname_2;
  public RCRBrl(RCRName p1, RCRName p2) { rcrname_1 = p1; rcrname_2 = p2; }

  public <R,A> R accept(coop.rchain.rhocomb.pi2rhocomb.Absyn.RCRComb.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof coop.rchain.rhocomb.pi2rhocomb.Absyn.RCRBrl) {
      coop.rchain.rhocomb.pi2rhocomb.Absyn.RCRBrl x = (coop.rchain.rhocomb.pi2rhocomb.Absyn.RCRBrl)o;
